...
3. **Commit changes.** Once you're happy with your changes, you should commit the change. By default, the commit message will describe which file you updated and it commits to the `main` branch. You can change the commit message and/or add an extended description to describe which changes you made. This is helpful in future when you want to understand changes you made previously. The `main` branch is the default branch and also generally the only branch, so you don't need to worry about that part.
    -  When you look at the list of folders and files in the repository, you can see some kind of message next to it and also a time stamp. These are telling you the description of the last commit which was used to change this folder/file and when the change happened. The files that haven't been changed for the longest time are files that you shouldn't expect to change, as they are defining basic website functionality from when this was all first created.
